...
import * as rippleUtil from '@material/ripple/util';
...
class MDCCheckbox extends MDCComponent {
   ...
   */
  initRipple_() {
    const MATCHES = rippleUtil.getMatchesProperty(HTMLElement.prototype);
...
export {MDCCheckbox, MDCCheckboxFoundation};
